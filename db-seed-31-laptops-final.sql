...
-- FIX: Added missing battery_wh values to budget rows (1-6) that caused column count mismatch
...
-- ======================== BUDGET (Under ₹50k) ========================
('Acer Aspire Lite AL15-41', 'Acer', 'acer-aspire-lite-al15-41', 45990, 'x86', 'AMD', 'U', 'Ryzen 5 5625U', 'integrated', 'Radeon Graphics', 0, 16, 'DDR4', 512, 'NVMe', 15.6, 'IPS', 60, 300, 45, 50, 1.8, 'Windows', ARRAY['programming','general','business'], 'Excellent value, strong CPU, 300 nits display, nationwide service', 'Integrated GPU, slower in gaming', 'https://amzn.to/3ShHMO9'),

('Lenovo IdeaPad Slim 3', 'Lenovo', 'lenovo-ideapad-slim-3', 52000, 'x86', 'Intel', 'U', 'Core i5-13420H', 'integrated', 'Intel Graphics', 0, 8, 'DDR5', 512, 'NVMe', 15.6, 'IPS', 60, 220, 45, 56, 1.65, 'Windows', ARRAY['programming','general'], 'Lightweight (1.65kg), 56Wh battery, 7hr battery life, responsive multitasking', 'Only 8GB RAM base, no dedicated GPU', 'https://amzn.to/4ak7mrZ'),

('HP 15s (Core i3)', 'HP', 'hp-15s-core-i3-gen13', 39219, 'x86', 'Intel', 'U', 'Core i3-1215U', 'integrated', 'Intel UHD Graphics', 0, 8, 'DDR4', 512, 'NVMe', 15.6, 'IPS', 60, 250, 45, 41, 1.69, 'Windows', ARRAY['general','business'], 'Budget-friendly, reliable HP service, lightweight, 7.5hr battery', 'Only 8GB RAM, i3 limited for heavy tasks', 'https://amzn.to/4vtYZm4'),

('Asus Vivobook Go 15', 'Asus', 'asus-vivobook-go-15', 50990, 'x86', 'AMD', 'U', 'Ryzen 3 7320U', 'integrated', 'Radeon Graphics', 0, 8, 'LPDDR5', 512, 'NVMe', 15.6, 'IPS', 60, 220, 45, 42, 1.63, 'Windows', ARRAY['programming','general'], 'Fast 49-min charge, thin & light, lightweight (1.63kg)', 'Only 8GB RAM base, no dedicated GPU', 'https://fktr.in/qJz7nA4'),

('Dell Inspiron 15 (Ryzen 5)', 'Dell', 'dell-inspiron-15-ryzen5', 53015, 'x86', 'AMD', 'U', 'Ryzen 5 7530U', 'integrated', 'Radeon Graphics', 0, 16, 'DDR5', 512, 'NVMe', 15.6, 'IPS', 120, 260, 45, 54, 1.67, 'Windows', ARRAY['programming','general','business'], 'Reliable Dell support, 120Hz display, good thermal design, upgradeable', 'Integrated graphics limits gaming, 7hr battery', 'https://amzn.to/49DenEh'),

-- ======================= MID-RANGE (₹50k-80k) =======================
('Lenovo LOQ 15IAX9', 'Lenovo', 'lenovo-loq-15iax9', 70000, 'x86', 'Intel', 'H', 'Core i7-12650HX', 'dedicated', 'RTX 4050', 70, 16, 'DDR5', 512, 'NVMe', 15.6, 'IPS', 144, 300, 72, 60, 2.38, 'Windows', ARRAY['gaming','video-editing','content'], '144Hz display, strong i7, RTX 4050 for 4K editing, upgradeable RAM', 'Battery life moderate (~5-6h), heavier than ultrabooks', 'https://fktr.in/AvFU6Tn'),
...
('HP Envy x360 14 (OLED)', 'HP', 'hp-envy-x360-14-oled', 99999, 'x86', 'Intel', 'P', 'Core Ultra (unspecified)', 'integrated', 'Intel Graphics', 0, 16, 'LPDDR5X', 512, 'NVMe', 14.0, 'OLED', 120, 400, 100, 68, 1.39, 'Windows', ARRAY['design','video-editing','ai-ml'], '2.8K OLED 48-120Hz variable refresh, 99.5% DCI-P3, convertible 2-in-1, light (1.39kg)', 'Integrated GPU only, premium price point', 'https://www.hp.com/in-en/shop/laptops-tablets/business-laptops/personal-laptops.html'),
...
('Alienware m16 R2 (RTX 4070)', 'Dell', 'alienware-m16-r2-rtx4070', 150000, 'x86', 'Intel', 'HX', 'Core Ultra 9 185H', 'dedicated', 'RTX 4070', 130, 32, 'DDR5', 1024, 'NVMe', 16.0, 'IPS', 240, 400, 100, 86, 2.61, 'Windows', ARRAY['gaming','video-editing','ai-ml'], 'RTX 4070 (130W), 240Hz QHD+ display, excellent thermals, 32GB DDR5, AI-ready', 'Expensive, heavy (2.61kg), battery life ~4-5h under gaming load', 'https://www.amazon.in/Dell-Smartchoice-Alienware-Alienfx-Metallic/dp/B0CYLXD4K5'),

('ASUS ROG Strix G16 (RTX 5070 Ti)', 'Asus', 'asus-rog-strix-g16-rtx5070ti', 299000, 'x86', 'Intel', 'HX', 'Core Ultra 9 275HX', 'dedicated', 'RTX 5070 Ti', 140, 32, 'DDR5', 1024, 'NVMe', 16.0, 'IPS', 240, 400, 100, 90, 2.65, 'Windows', ARRAY['gaming','video-editing','ai-ml'], 'RTX 5070 Ti (140W TGP), Core Ultra 9 HX, 32GB DDR5, 240Hz QHD+ gaming, MUX switch', 'Extremely expensive, battery life ~3-4h under intense load, runs hot', 'https://www.flipkart.com/asus-rog-strix-g16-2025-ai-pc-office-2024-m365-basic-intel-core-ultra-9-275hx-32-gb-1-tb-ssd-windows-11-home-12-gb-graphics-nvidia-geforce-rtx-5070-ti-240-hz-140-w-g615lr-s5190ws-gaming-laptop/p/itm59ca3b2dafe6c'),
...
-- ======================== AI/ML & BUSINESS ========================
('Lenovo ThinkPad X1 Carbon (Core Ultra)', 'Lenovo', 'lenovo-thinkpad-x1-carbon-core-ultra', 125000, 'x86', 'Intel', 'U', 'Core Ultra 7 155U', 'integrated', 'Intel Graphics', 0, 32, 'LPDDR5X', 512, 'NVMe', 14.0, 'IPS', 60, 400, 100, 57, 1.08, 'Windows', ARRAY['programming','ai-ml','business'], 'Ultra-light (1.08kg), legendary ThinkPad keyboard, MIL-SPEC durability, AI-ready', 'Integrated GPU, premium business pricing', 'https://www.amazon.in/Lenovo-ThinkPad-Fingerprint-Backlit-21KCS0CW00/dp/B0F6VQK6PQ'),

('HP OmniBook 5 (Ryzen AI 350)', 'HP', 'hp-omnibook-5-ryzen-ai-350', 85000, 'x86', 'AMD', 'U', 'Ryzen AI 350', 'integrated', 'Radeon Graphics', 0, 16, 'LPDDR5X', 512, 'NVMe', 15.6, 'IPS', 60, 350, 100, 75, 1.8, 'Windows', ARRAY['programming','ai-ml','general'], 'AI-optimized Ryzen 350 (47 TOPs NPU), 16GB LPDDR5X, 350 nits FHD display', 'Newer Ryzen AI ecosystem, integrated GPU only', 'https://www.hp.com/in-en/shop/laptops-tablets/personal-laptops/omnibook-5-laptops.html'),
